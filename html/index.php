...
<div class="jsc-sidebar-content jsc-sidebar-pulled sidebar" style="z-index:999">
    ...
    <section class="container">
        ...
        <div class="demo points_container" id="points_container">
            <div class="shape pdp_point depot" data-shape="Circle" title="depot" data-point-id="0" id="pdp_point_0">D
            </div>
            ...
            <div class="shape pdp_point" data-shape="Circle" title="100" data-point-id="100" id="pdp_point_100">100
            </div>
        ...
        <script>
            ...
            function getPdpPoint(point_id) {
                ...
                if (result.length === 0) {
                    console.log('Cannot get point #' + point_id)
                }
                ;
                return result;
            }
            ...
            function renderClusters(clusters) {
                ...
                var classes = '';
                for (var i = 0; i < 50; i++) classes += 'cluster' + i + ' ';
            ...
            <ul>
                <li id="cluster0">
                    <div>
                        ...
                        <button class="draw_cluster_path_step_by_step_button" data-cluster-id="0">draw path step by
                            step
                        </button>
                ...
                <li id="cluster1">
                    <div>
                        ...
                        <button class="draw_cluster_path_step_by_step_button" data-cluster-id="1">draw path step by
                            step
                        </button>
                ...
                <li id="cluster2">
                    <div>
                        ...
                        <button class="draw_cluster_path_step_by_step_button" data-cluster-id="2">draw path step by
                            step
                        </button>
                ...
                <li id="cluster3">
                    <div>
                        ...
                        <button class="draw_cluster_path_step_by_step_button" data-cluster-id="3">draw path step by
                            step
                        </button>
                ...
                <li id="cluster4">
                    <div>
                        ...
                        <button class="draw_cluster_path_step_by_step_button" data-cluster-id="4">draw path step by
                            step
                        </button>
                ...
                <li id="cluster5">
                    <div>
                        ...
                        <button class="draw_cluster_path_step_by_step_button" data-cluster-id="5">draw path step by
                            step
                        </button>
                ...
                <li id="cluster6">
                    <div>
                        ...
                        <button class="draw_cluster_path_step_by_step_button" data-cluster-id="6">draw path step by
                            step
                        </button>
                ...
                <li id="cluster7">
                    <div>
                        ...
                        <button class="draw_cluster_path_step_by_step_button" data-cluster-id="7">draw path step by
                            step
                        </button>
                ...
                <li id="cluster8">
                    <div>
                        ...
                        <button class="draw_cluster_path_step_by_step_button" data-cluster-id="8">draw path step by
                            step
                        </button>
                ...
                <li id="cluster9">
                    <div>
                        ...
                        <button class="draw_cluster_path_step_by_step_button" data-cluster-id="9">draw path step by
                            step
                        </button>
...
<script>
    ...
    $('#pdp_points_filename').on("change", function () {
        loadJsonFromFileContainerToMainTable();
    });
</script>
